...
public class CCMainFrame extends JFrame {
	...
	private static final int ERRORBUTTONWIDTH = 90;
	private static final int ERRORBUTTONHEIGHT = 90;
	...
	private void setCompileErrorButton() {
		...
		// ボタンを配置する
		int i = 0;
		for (int x = 0; x < width - ERRORBUTTONWIDTH * 2; x += ERRORBUTTONWIDTH) {
			for (int y = 30; y < height - ERRORBUTTONHEIGHT * 2; y += ERRORBUTTONHEIGHT) {
				if (i < buttons.size()) {
	...
	private void setMiniGraphButton() {
		...
		// TODO: ここにミニグラフをボタン上に配置するプログラムを書く
