...
public class CCMainFrame extends JFrame {
	...
	// TODO: method 及び変数のJavadocを用意しておくとなお良い
	/*********************
	 * Static Variables.
	 *********************/

	public static final String APP_NAME = "CC Viewer";
	...
	// Button Size
	// 現状だと75個置けてる感じ memo:Buttonは height < 25 だと文字列が潰れるからよろしくない
	private static final int ERRORBUTTONWIDTH = 350;
	private static final int ERRORBUTTONHEIGHT = 28;
	...
	private void initialize() {
		...
		// 全体のコンパイル数表示
		printCompileErrorNumber();

		// パネルの作成
		printCompileErrorPanel();
	...
	private void printCompileErrorNumber() {
	...
	// TODO: パネル出力をミニグラフに変える
	// TODO: レイアウトを変更したパネル出力
	private void printCompileErrorPanel() {
	...
	// 空のパネルを生成する
	private void printEmptyPanel(int x, int y) {
