...
public class CCCompileErrorLogCreater extends CCFileLoader {

	private CCCompileErrorManager manager;
	private FileWriter out;
	int count = 1;

	public CCCompileErrorLogCreater() {

	}

	public CCCompileErrorLogCreater(CCCompileErrorManager manager) {
	...
	protected void separeteData(String line) throws IOException {
		...
		// debug
		System.out.println("count : " + count++ + " : " + errorID + ","
				+ filename + "," + beginTime + "," + correctTime);
